...
> **Status: v1.0-draft — published for community review.** Site: [causalseal.org](https://causalseal.org)
...
- **[paper/PAPER.md](paper/PAPER.md)** — companion paper (draft): *Causal Seals: Decision Provenance for Governed Generation*.
